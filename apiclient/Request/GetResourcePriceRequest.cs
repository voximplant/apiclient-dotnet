...
namespace Voximplant.API.Request {
    ...
    public class GetResourcePriceRequest : BaseRequest
    {
        /// <summary>
        ...
        public Argument<string> ResourceType { get; set; }

        /// <summary>
        /// The price group ID list separated by the ';' symbol.
        /// </summary>
        [JsonProperty("price_group_id")]
        public Argument<long> PriceGroupId { get; set; }
        ...
        /// phone number list.
        /// </summary>
        [JsonProperty("resource_param")]
        public Argument<string> ResourceParam { get; set; }
